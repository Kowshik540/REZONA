...
const st = {
  ...
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 24, alignItems: 'start' },
  formCard: { background: '#1e1e2e', borderRadius: 12, padding: 24, border: '1px solid #2d2d3d' },
  resultCard: { background: '#1e1e2e', borderRadius: 12, padding: 24, border: '1px solid #2d2d3d', minHeight: 300 },
